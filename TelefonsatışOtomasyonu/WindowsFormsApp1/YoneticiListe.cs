...
{
    public partial class YoneticiListe : Form
    {
        ...
        {
            baglanti.Open();
            OleDbDataAdapter adtr = new OleDbDataAdapter("select * from kullanicilar where K_Yetki='Admin'", baglanti);
            adtr.Fill(tablo);
        ...
        private void YoneticiListe_Load(object sender, EventArgs e)
        {
            listele();
        }
        ...
        private void adminsil_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Close();
            MessageBox.Show(mesajlar.hatasinir17);
            tablo.Clear();
            listele();
        }
    }
